    ...
    <div class="container">
        ...
        <form action="join" method="get">
            ...
            <div class="checkbox-group">
                ...
                <div class="detail">
                    <textarea readonly>네이버 서비스 및 제품을 이용해 주셔서 감사합니다. 본 약관은 네이버 서비스의 이용과 관련하여 네이버 서비스를 제공하는 네이버와 회원 간의 관계를 설명하며...</textarea>
                </div>
            </div>
            <div class="checkbox-group">
                <label>
                ...
                <div class="detail">
                    <textarea readonly>개인정보보호법에 따라 네이버 회원가입 시 필요한 최소한의 개인정보를 수집합니다. </textarea>
                </div>
            </div>
            <div class="checkbox-group">
                <label>
